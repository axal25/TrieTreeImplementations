...
public class CNFConverterTest3 extends CNFConverterAbstractTest {
    public final static String inFilePath = "/src/main/resources/CNF/dimacs";
    public final static String inFileName = "ShorterCNFExample_MoreNodesThanKnuthExample.cnf";
    public final static String outFilePath = "/src/main/resources/CNF/processed";
    public final static String outFileName = "ShorterCNFExample_MoreNodesThanKnuthExample_sorted.txt";
