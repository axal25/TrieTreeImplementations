...
public class PatriciaTreeKnuthExampleJavaEncodingWordStratSPTEOFTest extends PatriciaTreeWordStratSPTEOFTest {
    public final static String filePath = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest.filePath;
    public final static String fileName = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest.fileName;
    ...
    public final static String[] fileStringArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest.fileStringArray;
    ...
    public final static String[] headerRepresentations = {
            PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest.headerRepresentations[0],
            "PatriciaNode{\n" +
                    "\tid = 0,\n" +
                    "\tkey = 0,\n" +
                    "\tskip = 0,\n" +
