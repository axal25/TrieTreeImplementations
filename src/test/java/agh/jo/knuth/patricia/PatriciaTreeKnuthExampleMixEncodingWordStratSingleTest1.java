...
public class PatriciaTreeKnuthExampleMixEncodingWordStratSingleTest1 extends PatriciaTreeWordStratSingleTest {
    ...
    public final static int[] charCodeArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest1.charCodeArray;
    public final static String[] binaryStringArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest1.binaryStringArray;
    ...
    public final static String[] headerRepresentations = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest1.headerRepresentations;
