...
public class PatriciaTreeKnuthExampleMixEncodingWordStratSingleTest2 extends PatriciaTreeWordStratSingleTest {
    ...
    public final static int[] charCodeArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest2.charCodeArray;
    public final static String[] binaryStringArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest2.binaryStringArray;
    ...
    public final static String[] headerRepresentations = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest2.headerRepresentations;
