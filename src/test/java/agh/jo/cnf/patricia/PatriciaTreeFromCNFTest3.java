...
import agh.jo.cnf.converter.CNFConverterTest3;
...
public class PatriciaTreeFromCNFTest3 extends PatriciaTreeFromCNFAbstractTest {
    public final static String filePath = CNFConverterTest3.outFilePath;
    public final static String fileName = CNFConverterTest3.outFileName;
    public final static char charEOF = CNFConverterTest3.outputEOF;
    public final static char charEOK = CNFConverterTest3.EOCNF;
    public final static Encoding encoding = Encoding.JAVA;
    public final static WordStrategy wordStrategy = WordStrategy.SINGLE;
    public final static CNFConverter cnfConverter = CNFConverterTest3.getNewCNFConverterAndAssert();
