...
public class CNFConverterTest1 extends CNFConverterAbstractTest {
    public final static String inFilePath = "/src/main/resources/CNF/dimacs";
    public final static String inFileName = "Analiza1-gss-20-s100.cnf";
    public final static String outFilePath = "/src/main/resources/CNF/processed";
    public final static String outFileName = "Analiza1-gss-20-s100_sorted.txt";
    public final static char EOCNF = '|';
    public final static char inputCNFdelimiterReplacement = '_';
