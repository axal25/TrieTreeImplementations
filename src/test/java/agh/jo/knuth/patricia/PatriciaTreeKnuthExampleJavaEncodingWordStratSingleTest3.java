...
public class PatriciaTreeKnuthExampleJavaEncodingWordStratSingleTest3 extends PatriciaTreeWordStratSingleTest {
    ...
    public final static int[] charCodeArray = PatriciaTreeKnuthExampleJavaEncodingWordStratSPTEOFTest3.charCodeArray;
    public final static String[] binaryStringArray = PatriciaTreeKnuthExampleJavaEncodingWordStratSPTEOFTest3.binaryStringArray;
    ...
    public final static String[] headerRepresentations = PatriciaTreeKnuthExampleJavaEncodingWordStratSPTEOFTest3.headerRepresentations;
