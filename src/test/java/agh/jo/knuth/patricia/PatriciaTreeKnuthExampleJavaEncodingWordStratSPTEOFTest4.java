...
public class PatriciaTreeKnuthExampleJavaEncodingWordStratSPTEOFTest4 extends PatriciaTreeWordStratSPTEOFTest {
    public final static String filePath = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.filePath;
    public final static String fileName = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.fileName;
    public final static char charEOF = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.charEOF;
    public final static char charEOK = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.charEOK;
    ...
    public final static String[] fileStringArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.fileStringArray;
    public final static String[] expectedCharStringArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.expectedCharStringArray;
    public final static int[] charPositionIndexArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.charPositionIndexArray;
    ...
    public final static int[] charCodeArray = {
        ...
        //  T,  H,  E, ' ',  'Φ',
            84, 72, 69, 32, 934,
        //  H,  O,  U,  S,  E, ' ', 'Φ',
            72, 79, 85, 83, 69, 32, 934,
        //  T,  H,  A,  T, ' ', 'Φ',
            84, 72, 65, 84, 32, 934,
        //  J,  A,  C,  K, ' ', 'Φ',
            74, 65, 67, 75, 32, 934,
        //  B,  U,  I,  L,  T, ' ', ';', 'Φ', 'Φ', 'Φ', 'Φ', 'Π'
            66, 85, 73, 76, 84, 32, 59, 934, 934, 934, 934, 928
    };

    public final static String[] binaryStringArray = {
        //  T,          H,          I,          S,          ' ',        'Φ',
        //  84,         72,         73,         83,         32,         934,
            "01010100", "01001000", "01001001", "01010011", "00100000", "0000001110100110",

        //  I,          S,          ' ',        'Φ',                'Φ',
        //  73,         83,         32,         934,                934,
            "01001001", "01010011", "00100000", "0000001110100110", "0000001110100110",

        //  T,          H,          E,          ' ',        'Φ',
        //  84,         72,         69,         32,         934,
            "01010100", "01001000", "01000101", "00100000", "0000001110100110",

        //  H,          O,          U,          S,          E,          ' ',        'Φ',
        //  72,         79,         85,         83,         69,         32,         934,
            "01001000", "01001111", "01010101", "01010011", "01000101", "00100000", "0000001110100110",

        //  T,          H,          A,          T,          ' ',        'Φ',
        //  84,         72,         65,         84,         32,         934,
            "01010100", "01001000", "01000001", "01010100", "00100000", "0000001110100110",

        //  J,          A,          C,          K,          ' ',        'Φ',
        //  74,         65,         67,         75,         32,         934,
            "01001010", "01000001", "01000011", "01001011", "00100000", "0000001110100110",

        //  B,          U,          I,          L,          T,          ' ',        ';',        'Φ',                'Φ',                'Φ',                'Φ',                'Π',
        //  66,         85,         73,         76,         84,         32,         59,         934,                934,                934,                934,                928,
            "01000010", "01010101", "01001001", "01001100", "01010100", "00100000", "00111011", "0000001110100110", "0000001110100110", "0000001110100110", "0000001110100110", "0000001110100000",
    };
    public final static int[] startPositionIndexArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.startPositionIndexArray;
    public final static int[] endPositionIndexArray = PatriciaTreeKnuthExampleMixEncodingWordStratSPTEOFTest4.endPositionIndexArray;
